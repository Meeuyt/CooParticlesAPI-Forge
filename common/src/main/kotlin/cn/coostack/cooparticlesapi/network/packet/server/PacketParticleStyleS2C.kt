...
class PacketParticleStyleS2C(
    ...
    companion object {
        private val identifierID = ResourceLocation(CooParticlesConstants.MOD_ID, "particle_style")
        val payloadID = ResourceLocation(CooParticlesConstants.MOD_ID, "particle_style")
